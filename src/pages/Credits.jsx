                ...
                <Card className="p-4">
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-300 bg-white min-h-[44px]">
                    ...
                    <div className="mt-2 text-xs text-gray-400 px-1">
                        {filteredCredits.length} kayıt bulundu
                    </div>
                </Card>
            )}
